      ...
      '<div class="modal-dialog">' +
        '<div class="modal-content text-center">' +
          '<div class="modal-body">' +
            ...
            '<h2 id="'+id+'Label" class="modal-title text-warning"></h2> ' +
          '</div>' +
          '<ul class="list-inline text-center">' +
            '<li><button class="btn cancel" data-dismiss="modal" aria-hidden="true"></button></li>' +
            '<li><button class="btn commit"></button></li>' +
          '</ul>'+
        '</div>'+
      '</div>'+
    '</div>'
